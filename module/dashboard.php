		...
		margin: 0px;
			...
			<tbody>
						...
						<tr>
							...
							<td width="30%" ><img class="mainlogo" src="https://www.techsourcescarborough.com/wp-content/uploads/2021/04/techsource-logo-lg.png"> </td>
	...
	Email : support@techsourcescarborough.com
			...
			<tbody>
						...
						<tr>
							...
							<span class="text-inverse">$ '. $results['tax'] .'</span>

							</td>

							<td width="30%"  bgcolor="#2d353c">

							 <small style="color:#FFFFFF;" >TOTAL</small> <span class="f-w-600" style="color:#FFFFFF;">$ '. $results['final_total'] .' </span>
